<?php
  require_once('adm/class/servico.php');
  ...
  require_once('adm/class/comotrab.php');
  ...
  require_once('adm/class/banner.php');

  $listaBanner = new BannerClass();
  $listarbanner = $listaBanner->ListarBann();
  ...
  $listarc = $listarContato->ListarCont();

  
  require_once('adm/class/usuario.php');
...
<body>
  ...
  <main>
    ...
    <!-- Como Trabalhamos -->
    <?php require_once('conteudo/comotrab.php'); ?>
